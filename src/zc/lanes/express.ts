 ...
 * RECEIVED → PRECHECKED → H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) → DECIDED_TO_SETTLE
 */
export async function processExpress(
  ...
  // H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) 状態に遷移
