 ...
 *   - Bypasses H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) entirely (`PRECHECKED → DECIDED_TO_SETTLE` directly).
 ...
 * （H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) はスキップ。中央銀行 RTGS = BOJ プレファンドで担保するため）
 */
export async function advanceHighValue(txid: string, env: Env): Promise<void> {
  ...
  // 5. PRECHECKED → DECIDED_TO_SETTLE（H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) をスキップ）
