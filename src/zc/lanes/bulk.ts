...
/**
 * Bulkバッチ処理: RECEIVED → PRECHECKED → H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) → DECIDED_TO_SETTLE
...
export async function advanceBulk(txid: string, env: Env): Promise<void> {
  ...
  // DECIDED_TO_SETTLE で lockH（H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) → LOCKED）
