...
export async function handlePostCancel(req: Request, txid: string, env: Env): Promise<Response> {
  ...
  const cancelableStates = ["RECEIVED", "PRECHECKED", "PRECHECKED_SUSPENDED", "H_RESERVED (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held) (H-reserve funds are held)"];
