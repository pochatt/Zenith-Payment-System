...
export const ALLOWED_TRANSITIONS: Record<TxState, TxState[]> = {
  ...
  PRECHECKED: ["PRECHECKED_SUSPENDED", "H_RESERVED", "DECIDED_CANCEL", "DECIDED_TO_SETTLE"], // HIGH_VALUE is PRECHECKED → DECIDED_TO_SETTLE
  PRECHECKED_SUSPENDED: ["PRECHECKED", "DECIDED_CANCEL"],
  H_RESERVED: ["DECIDED_TO_SETTLE", "DECIDED_CANCEL"],
  DECIDED_TO_SETTLE: ["PAYER_EXEC_CONFIRMED", "PAYEE_EXEC_CONFIRMED", "SUSPENDED"], // PAYEE_EXEC_CONFIRMED: GTID PAYEE needs no debit; direct credit confirmation
