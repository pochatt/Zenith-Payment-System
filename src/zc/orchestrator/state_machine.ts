...
export const ALLOWED_TRANSITIONS: Record<TxState, TxState[]> = {
  ...
  PRECHECKED: ["PRECHECKED_SUSPENDED", "H_RESERVED (H-reserve funds are held) (H-reserve funds are held)", "DECIDED_CANCEL", "DECIDED_TO_SETTLE"], // HIGH_VALUE は PRECHECKED → DECIDED_TO_SETTLE
  PRECHECKED_SUSPENDED: ["PRECHECKED", "DECIDED_CANCEL"],
  H_RESERVED (H-reserve funds are held) (H-reserve funds are held): ["DECIDED_TO_SETTLE", "DECIDED_CANCEL"],
