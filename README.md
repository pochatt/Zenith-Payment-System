...
この資料を煮るなり焼くなりしてもよいので、ぜひあなたのプロジェクトに活用してほしいです。将来あなたのプロジェクトが完成したときに Zenith を叩き台にしたと言ってくれれば、それで十分です。
...
Take this and put it to use however suits you — adapt it, take it apart, fold it into your own work. If, when your own project comes together one day, you mention that Zenith was the draft you started from, that will be more than enough.
